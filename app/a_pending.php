                        ...
                        <div class="panel-body minimal">
                            ...
                            <div class="table-inbox-wrap ">
                                <table class="table table-inbox table-hover">
                                    ...
                                    $sql = "SELECT * FROM application natural join users where status='pending' and admin=0 and department=1 ORDER BY subday DESC LIMIT ".$offset.", ".$no_of_records_per_page;
