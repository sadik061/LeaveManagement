...
$sql = "INSERT INTO users (user_name, email, password, designation_id, role) VALUES ('%s', '%s', '%s', '%s', '%s')";

$query = sprintf($sql,$_GET['user_name'], $_GET['email'],$_GET['password'],$_GET['parent_id'],$_GET['role']);
