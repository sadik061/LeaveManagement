            ...
            <div class="col-sm-9" style="margin-left: 25%;">
                <section class="panel">
                    <div class="compose-btn pull-right">
                        <a href="#" onclick="pdf()" class="btn btn-sm btn-theme"><i class="fa fa-download"></i> Download
                        </a>
                    </div>
                            ...
                            if ($application_Status == "pending") {
                                if ($_SESSION["role"] == "super_admin" || $_SESSION["role"] == "department_head") { ?>
                                    <form class="form-horizontal style-form" action="core/Approved.php" method="get">
                                        ...
                                        <div class="col-md-1">
                                            <div class="compose-btn pull-right">
                                                <button type="submit" class="btn btn-sm btn-theme"><i class="fa fa-reply"></i> Apply
                                                </button>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div>
                            ...
                            ?>
                                <h4>I am writing this letter to inform and to get permission for the leaves
                                    ...
                                    <a href="showProfile.php?userid=<?php echo $row["user_id"] ?>" ?>
...
<script>
    function pdf() {
        var HTML_Width = $("#download").width();
        var HTML_Height = $("#download").height();
        ...
        html2canvas($("#download")[0]).then(function(canvas) {
