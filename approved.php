                        ...
                        <div class="panel-body minimal">
                            ...
                            <div class="table-inbox-wrap ">
                                <table class="table table-inbox table-hover">
                                    ...
                                    $total_pages_sql = "SELECT COUNT(*) FROM application natural join users where status='approved' and  user_id=" . $_SESSION["userid"];


                                    $result = $conn->query($total_pages_sql);
                                    $total_rows = mysqli_fetch_array($result)[0];
                                    $total_pages = ceil($total_rows / $no_of_records_per_page);
                                    $sql = "SELECT * FROM application natural join users where status='approved' and  user_id=" . $_SESSION["userid"]." LIMIT ".$offset.", ".$no_of_records_per_page;
