    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row mt">
                ...
                $sql = "SELECT * FROM users inner join designation on users.designation_id=designation.designation_id where user_id=" . $_GET["userid"];
                ...
                <div class="col-sm-9" style="margin-left: 25%;">
                    <section class="panel">
                        ...
                        <div class="panel-body ">
                            <form class="form-horizontal style-form" action="core/updateuser.php"
